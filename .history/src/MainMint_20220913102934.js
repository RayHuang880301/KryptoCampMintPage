...
import { useAccount, useContract, useSigner, useConnect, chain, useContractWrite, useSwitchNetwork } from 'wagmi'
...
const MainMint = ({ accounts, setAccounts }) => {
  ...
  // const getConnectedChainId = useMimo

  useEffect(() => {
    console.log({connectData,  address})
		if(connectData?.chain.id !== validChainId) {
			switchNetwork?.(validChainId);
		}
	}, [address, connectData, switchNetwork]);
